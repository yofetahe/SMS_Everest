...
public class DateConvertor {
	...
	/////////////////////// a method to convert gregorian date to Ethiopian
	/////////////////////// calendar
	public static String dateConvertor(String x) {
		...
		int month_num = 0;
		String[] g_months = new String[] { "January", "February", "March", "April", "May", "June", "July", "August",
				"September", "October", "November", "December" };
		String[] eth_months = new String[] { "Meskerem", "Tikemet", "Hidar", "Tahesas", "Tir", "Yekatit", "Megabit",
				"Miayazia", "Genbot", "Sene", "Hamle", "Nehase", "Pagume" };
		...
		// String converted_eth_date = eth_day + "-" + eth_month + "-" +
		// eth_year;
	...
	/////////////////////// a method to calculate the difference b/n two
	/////////////////////// ethiopian dates
	public static int dateDifference(String date1, String date2) {
		/////////////////////// to calculate the differnce b/n two gregorian
		/////////////////////// calendar after converting to ethiopian calendar
		/////////////////////// dates
		// String eth_date1 = dateConvertor(date1);
		// String eth_date2 = dateConvertor(date2);
		/////////////////////// to calculate the differnce b/n two ethiopian
		...
		/////////////////////// the total number of days when the two interval
		/////////////////////// falls in the same year and in different years
		if (eth_date2_comp[3].equals(eth_date1_comp[3])) {
			...
			/////////////////////// total number of days b/n the two months of
			/////////////////////// the given dates
			...
			/////////////////////// total number of days exactly b/n the given
			/////////////////////// dates
			...
			for (int i = Integer.parseInt(eth_date1_comp[3]) + 1, j = 0; i < Integer
					.parseInt(eth_date2_comp[3]); i++, j++) {
				totalFullYears[j] = i;
			}
			...
			if (Integer.parseInt(eth_date1_comp[3]) % 4 == 0) {
				numberOfDaysOffirstDateGiven = numberOfMonthsOffirstDateGiven * 30 + 6
						+ (30 - Integer.parseInt(eth_date1_comp[0]) + 1);
			} else if (Integer.parseInt(eth_date1_comp[3]) % 4 != 0) {
				numberOfDaysOffirstDateGiven = numberOfMonthsOffirstDateGiven * 30 + 5
						+ (30 - Integer.parseInt(eth_date1_comp[0]) + 1);
			}
