...
<div id="collBody">
	<s:set var="total_collection" value="report_bean.grand_total"/> 
	
	<div class="save_update_btn" onclick="emailTodaysCollection('${total_collection}')" style="height: 30px; width: 220px; padding-bottom: 5px; padding-left: 25px; cursor: pointer; text-align: center;">
		<table><tr><td>
			<img alt="email" src="images/email.png" height="30px">
		</td><td valign="middle">	
			Email Today's Collection
		</td></tr></table>
	</div>
	...
	<table id="payment_col" width="100%" ><thead><tr><td align="center" style="font-weight: bold; font-size: 20px; height: 60px; vertical-align: middle;">
		...
		<span style="font-size: 14px;">
			<s:property value="report_bean.col_date_from"/> Collection
		</span>
	...
	<table id="payment_col" width="100%" cellpadding="0" cellspacing="1" rules="rows" bgcolor="#fff">
		...
		<tr style="height: 30px;">
				...
				<td align="right" style="font-weight: bold;">
					<s:property value="report_bean.grand_total"/> 
				</td>
			</tr>
	</table>
	</td></tr></table>
