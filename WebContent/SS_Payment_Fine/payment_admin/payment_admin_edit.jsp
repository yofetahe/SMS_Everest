	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td style="padding-top: 1px">
				<div class="menu_shadow" style="background-color: #f5f5f5; height: 35px; padding-top: 15px; background-image: url('images/title_bg.png'); background-repeat: repeat; background-position: bottom;">
		...
		<tr><td>
			<button onclick="updatePaymentInfo('${pc_id}')" class="btn">Update</button>						
		</td></tr>
					</table>					
