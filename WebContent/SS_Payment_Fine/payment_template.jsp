													...
													<table width="100%" cellpadding="0" cellspacing="0">
														<tr>
															<td style="height: 35px;">
																<div class="menu_shadow" style="height: 35px; padding-top: 15px; color: #3d6e9f; background-position: bottom;">
																	<table cellpadding="0" cellspacing="0"><tr><td>			
																		<div style="color: #3d6e9f; cursor: pointer;" onclick="paymentInfo()"> 
																																
																		<table><tr><td id="paymentInformation" style="padding-top: 5px;"> 														
																		<img alt="click" src="images/next.gif" width="8px"> 
																		</td><td> Payment Information </td></table>
																		
																		</div>																
																	</td>
																	<td width="60px">&nbsp;</td>
																	<td>
																		<div style="color: #3d6e9f; cursor: pointer;" onclick="todaysCollection()">
																		
																		<table><tr><td id="todaysCollection" style="display: none; padding-top: 5px;"> 														
																		<img alt="click" src="images/next.gif" width="8px"> 
																		</td><td> Today's Collection </td></table>
														...
														<tr>
															<td style="padding-top: 10px">
																...
																<div class="content_background" style="min-height: 435px">
																	<div id="payment_content">
																		<s:include value="payment_info/payment_info_template.jsp"/>
																	</div>
																</div>
