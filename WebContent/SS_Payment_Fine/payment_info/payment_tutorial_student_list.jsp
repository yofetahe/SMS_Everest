				...
				<tr height="30px">
					...
					<td align="center">
						...
						<s:if test="%{#sep == 1}">
							...
							<s:else>
							<div onclick="selectedMonthForTutorial('sep', '${siid}', '${fname}', '${mname}', '${gname}')" style="cursor: pointer">
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#sep == 1}">
								<div onclick="selectedMonthForTutorial('oct', '${siid}', '${fname}', '${mname}', '${gname}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>								
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#oct == 2}">
								<div onclick="selectedMonthForTutorial('nov', '${siid}', '${fname}', '${mname}', '${gname}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#nov == 3}">
							<div onclick="selectedMonthForTutorial('dec', '${siid}', '${fname}', '${mname}', '${gname}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#dec == 4}">
								<div onclick="selectedMonthForTutorial('jan', '${siid}')" style="cursor: pointer">
								<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#jan == 5}">
								<div onclick="selectedMonthForTutorial('feb', '${siid}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#feb == 6}">
								<div onclick="selectedMonthForTutorial('mar', '${siid}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#mar == 7}">
								<div onclick="selectedMonthForTutorial('apr', '${siid}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#apr == 8}">
								<div onclick="selectedMonthForTutorial('may', '${siid}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
					...
					<td align="center">
						...
						<s:else>
							<s:if test="%{#may == 9}">
								<div onclick="selectedMonthForTutorial('jun', '${siid}')" style="cursor: pointer">
									<img alt="-" src="images/check_box.png" width="18px"/>
								</div>
							</s:if>
							<s:else>-</s:else>
