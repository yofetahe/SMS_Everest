...
<div style="border: thin; border-color: black; border-style:solid; border-width: thin; background-color: #fff; padding: 5px;">
				...
				<td style="padding-top: 10px;">
							...
							<td style="padding-top: 10px;">
								...
								<table cellpadding="0" cellspacing="0" width="100%" style="border: thin; border-style: dotted; border-color: silver;  border-width: thin; font-size: 14px;">
									...
									<tr style="font-weight: bold; border-top: thin; border-top-color: black; border-top-style: solid; border-top-width: thin;">
										...
										<td align="right"> &nbsp; </td>
										<td align="right"> &nbsp; </td>
										<td align="right" style="padding-right: 5px;"> <s:property value="payment_receipt_info[0].other_payment"/> </td>
									</tr>		
									<tr>								
										...
										<td align="right" style="border-top: thin; border-top-color: black; border-top-style: dotted; border-top-width: thin; padding-right: 5px;"> 
											<s:property value="payment_receipt_info[0].payment_grand_total"/> 
										</td>
									</tr>
								</table>
					...
					<table width="100%" cellpadding="0" cellspacing="0" style="font-size: 14px;">
						<tr height="30px;">
							...
							<td style="background-color: #f5f5f5; border: thin; border-color: black; border-style: dotted; border-width: thin; padding-left: 10px;"> <s:property value="payment_receipt_info[0].payment_grand_total_in_word"/> </td>
						</tr>
					</table>
	...
	<!-- 				Note: <br/> __________________________________________________________________________<br/>				 -->
	<!-- 				</td></tr></table>				 -->
	<!-- 			</td> -->
	<!-- 		</tr> -->
			<tr>
