...
// 					 	autoHeight: false 
// 					});
// // 		            $("#accordion  > div").accordion("option", "icons",
...
<!-- 	<div id="accordion"> -->
<!-- 		<div> -->
<!-- 			<h3 id="acc_name" onmouseover="this.style.backgroundColor = '#fff'; this.style.color = '#000'" onmouseout="this.style.backgroundColor = 'transparent'"><a href="#">Child Rights and Protection  - Part 1</a></h3> -->
<!-- 			<div>test</div> -->
<!-- 		</div> -->
<!-- 	</div> -->
					...
					<s:if test="%{#mcheck > 0}">
						<s:if test="%{#mshort != \"jul\" && #mshort != \"aug\"}">
							<tr>
								...
								<td align="right" >
									<div id="${mshort}" onclick="payMonthSelectedForNormalClass('${month_id}', '${mshort}', '${mlong}', '${inintialMonth_id}', '${si_id}', '${pc_id}', '${clid}', '${payment_type}', '${snc_id}')" style="cursor: pointer;">
										Add
									</div>
								</td>
							</tr>
		...
		<tr>
			<td>
				...
				<table width="80%"><tr><td style="padding-left: 60px;">
					<div class="save_update_btn" onclick="saveEducationPayment('${si_id}', '${pc_id}', '${month_id}', '${clid}', '${payment_type}', '${snc_id}')" style="height: 30px; text-align: center; color: #3d6e9f; width: 240px; padding-top: 8px; cursor: pointer;">
						Save
					</div>
				</td></tr></table>
			</td>
