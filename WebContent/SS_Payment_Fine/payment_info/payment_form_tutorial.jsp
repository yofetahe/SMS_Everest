...
<div id="paymentForMoreMonth">
					...
					<s:if test="%{#mcheck > 0}">
						<s:if test="%{#mshort != \"jul\" && #mshort != \"aug\"}">
							<tr>
								...
								<td align="right" >
									<div id="${mshort}" onclick="payMonthSelectedForTutorial('${month_id}', '${mshort}', '${mlong}', '${inintialMonth_id}', '${si_id}', '${pc_id}', '${clid}', '${payment_type}')" style="cursor: pointer;">
										Add
									</div>
								</td>
							</tr>
	...
	<table style="padding-top: 5px;">		
		...
		<tr><td>
			<button onclick="saveTutorialPayment('${si_id}', '${pc_id}', '${month_id}', '${clid}', '${payment_type}')" class="btn">Save</button>						
		</td></tr></table>
			</td>
		</tr>
	</table>
