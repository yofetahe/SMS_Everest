...
<body>
	...
	<div style="height: 35px;">&nbsp;</div>
		...
		<table id="stud_list" width="100%" cellpadding="0" cellspacing="2">
			...
			<tr height="30px">
					<td>
						<s:set var="siid" value="payment_table_per_student.si_id"/>
					...
					<td align="center">
						...
						<s:set var="sep" value="payment_table_per_student.sep"/>
						<s:if test="%{#sep == 1}">
					...
					<td align="center">
						...
						<s:set var="oct" value="payment_table_per_student.oct"/>
						<s:if test="%{#oct == 2}">
					...
					<td align="center">
						...
						<s:set var="nov" value="payment_table_per_student.nov"/>
						<s:if test="%{#nov == 3}">
					...
					<td align="center">
						...
						<s:set var="dec" value="payment_table_per_student.dec"/>
						<s:if test="%{#dec == 4}">
					...
					<td align="center">
						...
						<s:set var="jan" value="payment_table_per_student.jan"/>
						<s:if test="%{#jan == 5}">
					...
					<td align="center">
						...
						<s:set var="feb" value="payment_table_per_student.feb"/>
						<s:if test="%{#feb == 6}">
					...
					<td align="center">
						...
						<s:set var="mar" value="payment_table_per_student.mar"/>
						<s:if test="%{#mar == 7}">
					...
					<td align="center">
						...
						<s:set var="apr" value="payment_table_per_student.apr"/>
						<s:if test="%{#apr == 8}">
					...
					<td align="center">
						...
						<s:set var="may" value="payment_table_per_student.may"/>
						<s:if test="%{#may == 9}">
					...
					<td align="center">
						...
						<s:set var="jun" value="payment_table_per_student.jun"/>
						<s:if test="%{#jun == 10}">
