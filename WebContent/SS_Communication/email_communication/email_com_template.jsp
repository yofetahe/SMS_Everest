...
<script src="js/sms_communication.js" type="text/javascript"></script>
														...
														<table cellpadding="0" cellspacing="0">
															<tr>
																<td align="center" id="rlistArraw">
																	<div id="rsltListArraw">
																		&nbsp;
																	</div>										
																</td>
																<td>
																	<div style="cursor: pointer; color: #3d6e9f" onclick="studRsltList()"> &nbsp; Email Communication </div>										
																</td>
												...
												<tr>
													<td style="padding-top: 10px">
														<div class="content_background"  style="min-height: 434px">						
															...
															<s:include value="email_form.jsp"/>
