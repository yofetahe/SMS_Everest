...
<body>
	...
	<div id="studwithid">
		...
		<table id="stud_with_id_rslt" width="100%" cellpadding="0" cellspacing="2">
			<thead>
			...
			<s:iterator status="stat" value="stud_with_id_rslt">
				<tr height="35px">
					<td align="center">
					...
					<td>
						<div style="color: #3d6e9f; cursor: pointer">
							<s:property value="stud_with_id_rslt[#stat.index].fname"/> &nbsp; <s:property value="mname"/> &nbsp; <s:property value="gname"/>
						</div>									
					</td>
					<td align="left">
						<div >
							<s:property value="stud_with_id_rslt[#stat.index].id_no"/>
						</div>
					</td>			
				</tr>
			</s:iterator>
