	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td style="width: 15%; padding-left: 5px;" valign="top">
				...
				<div class="menu_button" onclick="generateIdCardForRemaining()" align="center" style="height: 29px;" onmouseover="this.style.color = '#3d6e9f'" onmouseout="this.style.color = '#000000'">
					Generate ID Card
				</div>
				<br/>
					...
					<s:iterator status="stat" value="grade_rslt">
						<tr>
							<td align="center" onmouseover="this.style.color = '#3d6e9f'" onmouseout="this.style.color = '#000000'">
								...
								<div class="menu_button" id="${clid}" onclick="gradeSelectedForIDCard('${clid}', '${clname}')">
