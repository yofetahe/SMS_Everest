					...
					<tr>
						<s:iterator status="st" value="sortedClassSchedulePerTeacher[#stat.index]">
							<s:if test="%{#stat.index == \"0\"}">
								<td style="background-color: #f5f5f5; height: 50px; padding-left: 5px; text-align: center; color: #3d6e9f; width: 15px; border-color: #f5f5f5;">
							...
							<s:else>
								<td style="border-color: #f5f5f5; border-style: solid; border-width: thin; text-align: center; vertical-align: top; padding-top: 10px; width: 15px;">
