				...
				<table><tr><td>
					...
					<div class="formboarder">
						<table style="padding-top: 20px; padding-bottom: 20px;">
							...
							<s:textarea label="Evaluation Content" id="eval" name="cm_evaluation" cols="30" rows="5" style="width: 200px;"/>
							
							<s:submit onclick="saveClubMemberEvaluation('${cm_id}', '${clbid}')" value="Save"/>
						</table>
					</div>
				</td></tr></table>
			</td>
