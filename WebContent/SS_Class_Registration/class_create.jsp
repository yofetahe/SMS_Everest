			...
			<td style="padding-top: 10px">
				<div class="content_background" style="min-height: 380px">
					...
					<table align="left"><tr><td>
						<s:textfield id="class_name" label="Class Name" required="true" style="height: 25px; width: 200px"/>
						<s:textfield id="class_number" label="Class Number" required="true" style="height: 25px; width: 200px"/>
						
						<s:submit onclick="saveClass()" value="Save"/>
					</td></tr></table>
				</div>
