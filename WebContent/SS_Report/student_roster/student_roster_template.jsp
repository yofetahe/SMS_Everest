	...
	<div style="width: 100%; background-color: #f5f5f5;">
		<table><tr>
			...
			<td>
				...
				<table>
					<s:select label="Quarter" id="at_id" list="sem_list" listKey="at_id" listValue="at_name" headerKey="0" headerValue="---" onchange="classRoomList(this.value)" style="width: 106px; height: 25px;"/>
				</table>
			</td><td>&nbsp;</td>
			<td>
				<table><tr><td>
