		...
		<table id="stud_list" width="100%" cellpadding="0" cellspacing="2">
			...
			<s:iterator status="stat" value="stud_rslt">
				<tr height="35px">
					...
					<td>
						<div style="color: #3d6e9f; cursor: pointer" onclick="student_edit_candidate('${idno}', '${siid}', '${fname}', '${mname}', '${gname}', '${sex}', '${dob}', '${pob}', '${nationality}', '${sistatus}', '${mothername}', '${photo_path}', '${photo_name}')">
					...
					<td style="text-align: center;">
						<div style="color: #3d6e9f; cursor: pointer;" onclick="deleteRegisteredCandidate('${siid}')">
						Delete
						</div>
					</td>						
				</tr>
