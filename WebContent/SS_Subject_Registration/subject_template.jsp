...
<script src="js/sms_subject_registration.js" type="text/javascript"></script>
</head>
									...
									<div id="subjectList">
										<table width="100%" style="min-height: 420px" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td width="1%">&nbsp;</td>
												<td valign="top">
													<div id="subjectListFrm">
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td width="48%" valign="top" style="padding-top: 1px">
																	<div id="subjectFrm">
																		<s:include value="subject_list.jsp"/>
																	</div>
																</td>
																<td>
																	&nbsp;
																...
																<td width="48%" valign="top" style="padding-top: 1px">
																	<div id="examtypeFrm">
																		<s:include value="exam_type/examtype_list.jsp"/>
																	</div>
																</td>			
															</tr>
														</table>				
